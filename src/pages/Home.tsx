...
import { Shield, ArrowRight, Play, Globe2, Lock, FileText, Sparkles, ChevronRight } from 'lucide-react';
...
export const Home: React.FC = () => {
  ...
  const handleDemoLogin = async () => {
    try {
      ...
      notificationService.success('Welcome to the demo!');
      navigate('/dashboard');
    } catch (error) {
      notificationService.error('Failed to access demo');
    }
  };
      ...
      <div className="bg-gradient-to-r from-blue-600 to-purple-600 py-2">
        <div className="container mx-auto px-6 flex items-center justify-center">
          <button
            ...
            className="flex items-center space-x-2 bg-white/10 hover:bg-white/20 text-white px-4 py-1.5 rounded-lg transition-all duration-300 transform hover:scale-105"
          >
